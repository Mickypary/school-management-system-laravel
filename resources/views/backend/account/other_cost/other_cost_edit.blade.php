						...
						<!-- <div class="col-12"> -->
							...
							<div class="row"> <!-- Start 1st row -->
								...
								<div class="col-md-3">
									<div class="form-group">
										<div class="controls" >
											<img id="showImage" src="{{ (!empty($editData->image) ? url('upload/cost_images/'.$editData->image) : url('upload/no_image.jpg'))  }}" style="width: 100px; height: 100px; border:1px solid #000000">
										</div>
									</div>
								</div>
