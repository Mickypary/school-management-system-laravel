    ...
    @endif
        ...
        <li class="treeview {{ ($prefix == '/profile') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'password.change') ? 'active' : ''}}"><a href="{{ route('password.change') }}"><i class="ti-more"></i>Change Password</a></li>
          </ul>
        </li>
        ...
        <li class="treeview {{ ($prefix == '/setups') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'subject.view') ? 'active' : ''}}"><a href="{{ route('subject.view') }}"><i class="ti-more"></i>Subject</a></li>
        ...
        <li class="treeview {{ ($prefix == '/employee') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'employee.salary.view') ? 'active' : ''}}"><a href="{{ route('employee.salary.view') }}"><i class="ti-more"></i>Employee Salary Increment</a></li>
        ...
        <li class="treeview {{ ($prefix == '/accounts') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'student.fee.view' || $route == 'student.fee.add') ? 'active' : ''}}"><a href="{{ route('student.fee.view') }}"><i class="ti-more"></i>Student Fee</a></li>
            ...
            <li class="{{ ($route == 'other.cost.view' || $route == 'other.cost.add') ? 'active' : ''}}"><a href="{{ route('other.cost.view') }}"><i class="ti-more"></i>Other Cost</a></li>
          </ul>
        </li>
