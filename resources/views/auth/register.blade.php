...
<head>
  <meta charset="utf-8">
    ...
    <title>Mickypary ERP - Registration </title>
                            ...
                            <form action="{{ route('register') }}" method="post">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" name="password_confirmation" id="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password">
                                    </div>
                                </div>
                                  <div class="row">
                                    <div class="col-12">
