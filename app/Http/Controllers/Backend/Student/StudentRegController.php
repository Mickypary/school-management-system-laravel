...
class StudentRegController extends Controller
{
    ...
    public function StudentRegEdit($student_id, $year_id)
    {
        $data['classes'] = StudentClass::all();
        $data['years'] = StudentYear::all();
        $data['shifts'] = StudentShift::all();
        ...
        $data['editData'] = AssignStudent::with(['student','discount'])->where('student_id', $student_id)->where('year_id', $year_id)->first();
    ...
    public function StudentEditPromotion($student_id)
    {
        $data['classes'] = StudentClass::all();
        $data['years'] = StudentYear::all();
        $data['shifts'] = StudentShift::all();
